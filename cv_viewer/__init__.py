...
# zed sdk -- 骨骼点对应 2-15
key_points = [
    sl.BODY_PARTS.NOSE, sl.BODY_PARTS.LEFT_SHOULDER, sl.BODY_PARTS.LEFT_ELBOW,
    sl.BODY_PARTS.LEFT_WRIST, sl.BODY_PARTS.RIGHT_SHOULDER, sl.BODY_PARTS.RIGHT_ELBOW,
    sl.BODY_PARTS.RIGHT_WRIST, sl.BODY_PARTS.LEFT_HIP, sl.BODY_PARTS.LEFT_KNEE,
    sl.BODY_PARTS.LEFT_ANKLE, sl.BODY_PARTS.RIGHT_HIP, sl.BODY_PARTS.RIGHT_KNEE,
    sl.BODY_PARTS.RIGHT_ANKLE, sl.BODY_PARTS.NECK
]
